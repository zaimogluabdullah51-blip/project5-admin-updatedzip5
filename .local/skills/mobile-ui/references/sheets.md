...
| Presentation | Use When | Appearance |
|--------------|----------|------------|
| `formSheet` | Single screen, no nested navigation | Partial card from bottom with detents |
| `modal` | Multi-step flows with nested Stack | Full-screen overlay |
...
| `sheetExpandsWhenScrolledToEdge` | `boolean` | Expand when scrolling to edge (default: true) |
